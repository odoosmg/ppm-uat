...
export class GoogleMapRenderer extends Component {
    ...
    addMarkers() {
        ...
        for (const markerInfo of Object.values(markersInfo)) {
            ...
            const iconInfo = {
                ...
                html: renderToString("google_map_view.marker", params),
            };
    ...
    createMarkerPopup(markerInfo, latLongOffset = 0) {
        ...
        const popupHtml = renderToString("google_map_view.markerPopup", {
            fields: popupFields,
    ...
    onTeamFilterAction(record){
        console.log(record);
//        this.props.model.metaData.domain.push(['user_id', '=', record.user_id[0]]);
//        this.props.model.load();
    }
}

GoogleMapRenderer.template = "google_map_view.MapRenderer";
