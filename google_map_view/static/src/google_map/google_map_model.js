...
export class GoogleMapModel extends Model {
    setup(params, { notification, http }) {
        ...
        this.data = {
            ...
            showSaleTeam: this.metaData.showSaleTeam,
        };
    ...
    async _fetchData(metaData) {
        const data = {
            ...
            filterData:[],
            showSaleTeam: metaData.showSaleTeam,
        };
        ...
        const filterObject = await this._fetchFilterObject();
        for(let record of filterObject){
            data.filterData.push(record);
        }
    ...
    _fetchFilterObject(){
        return this.orm.searchRead('ppm.sale.member', [], ['name', 'user_id'], { limit: 10 });
    }
...
GoogleMapModel.services = ["notification", "http"];
GoogleMapModel.COORDINATE_FETCH_DELAY = 1000;
